...
import com.example.administrator.smallworkdogs.functiontools.TimeCount;
import com.example.administrator.smallworkdogs.registrations.ActivityReg;
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_getvercode:
                ...
                if(phone1!=null &&!"".equals(phone1)) {
                    ...
                    timeCount.start();
                    BmobSMS.requestSMSCode(phone1, "小遛", new QueryListener<Integer>() {
                        @Override
